...
Paleta::Paleta(QGraphicsScene *scene, QGraphicsItem *parent)
    : QGraphicsPixmapItem(parent), velocidad(10), escena(scene) { // Constructor de la paleta
    QPixmap pixmap(":/Barra.png"); // Carga la imagen de la paleta
    setPixmap(pixmap.scaled(100, 20)); // Establece la imagen de la paleta y la escala
}
